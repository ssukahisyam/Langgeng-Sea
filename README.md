...
- 📓 **Log Book Digital** — catat hasil tangkap, BBM, cuaca, kru.
- 📊 **Dashboard Statistik** — evaluasi performa mingguan / bulanan.
- 📍 **Marker Kustom** — tandai spot produktif, karang, pelabuhan.
- 📤 **Ekspor / Impor** — GPX (universal) & `.lsea.json` (share antar pengguna).
...
## 🚀 Getting Started (akan diisi saat M0 Setup selesai)

```bash
# Prasyarat: Flutter 3.24+
flutter --version
...
|---|---|---|
| M0 Setup & Foundation | 1 minggu | Project siap, CI/CD |
| M1 Core Map & GPS | 2 minggu | Peta + posisi realtime |
| M2 Haul Tracking | 2 minggu | Start/stop + rekam + metrik |
...
Kami terbuka untuk feedback & kontribusi, terutama dari:
- Nelayan trawl Indonesia (untuk validasi kebutuhan).
- Developer Flutter (untuk PR).
- Peneliti perikanan (untuk fitur & data).
